...
1.  เปิดไฟล์ `LABS\Scripts\01_Missing_Index.sql`
...
1.  รัน `LABS\Scripts\06_Advanced_Index_Analysis.sql`
...
### Steps (ขั้นตอน)
1.  เปิดและรัน: `LABS\Scripts\02_Index_Analysis_QueryStore.sql`
...
2.  **Check Status**: รัน `LABS\Scripts\03_Check_Stale_Stats.sql`
...
2.  **Check Status**: รัน `LABS\Scripts\05_Check_Bad_Indexes.sql`
