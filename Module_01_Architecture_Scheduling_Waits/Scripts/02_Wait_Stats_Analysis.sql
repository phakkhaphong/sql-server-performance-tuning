...
(
    SELECT
        ws.wait_type
    ,   ws.wait_time_ms / 1000.0 AS [WaitS]
    ,   (ws.wait_time_ms - ws.signal_wait_time_ms) / 1000.0 AS [ResourceS]
    ,   ws.signal_wait_time_ms / 1000.0 AS [SignalS]
...
,   CAST(N'https://www.sqlskills.com/help/waits/' + MAX(W1.wait_type) AS XML) AS [Help_URL]
FROM [Waits] AS W1
...
GROUP BY
    W1.[RowNum]
,   W1.wait_type
HAVING SUM(W2.[Percentage]) - MAX(W1.[Percentage]) < 99.0 -- cumulative threshold
ORDER BY
    [Wait Percentage] DESC;
